...
def test_n_predictions():
    assert execute_pipeline('Since when does the Excellence Program of BNP Paribas exist?', 5) == [('January 2016', 'BNP Paribas’ commitment to universities and schools'), ('two years', 'BNP Paribas’ commitment to universities and schools'), (
        '18-month', 'BNP Paribas Graduate Programs in France'), ('What types of positions are available through the VIE program? What destinations', 'Making the most of your VIE!'), ('While Master’s', 'BNP Paribas Graduate Programs in France')]
